...
// mobile video controls
    ...
    function hashChangedCallback(newHash, oldHash) {
        ...
        if (newHash.indexOf('-SEPSLIDE-start') > -1) {
            ...
            // if its a video unit and not mobile
            if ($('#video-section').length > 0 && !isMobile.any) {
                ...
                if(typeof jwplayer() == 'undefined'){
                    openVideo('HERO_30_YAHOO-640.mp4','intro',true,'HERO_30_YAHOO-640.jpg');
                }
                else {
    ...
    var videoPlayer = function (video, posterImage, videoPrettyName) {
        ...
        jwplayer.key = "wK7eTrZ5SKJIVMpoKVgUi57uw4omDtNdnzewQBtMXlE=";
            ...
            jwplayer('video-container').setup({
                playlist: [{
                    ...
                    sources: [
                        ...
                        {file: "http://files.adspdbl.com/au_king_furniture_win_sale_003/assets/" + video.replace('m3u8','mp4')},
                        {file: "http://files.adspdbl.com/au_king_furniture_win_sale_003/assets/" + video.replace('m3u8','webm')}
                    ]
                }],
                width: "100%",
                height: "100%",
        ...
        if (tubemogul || contentplay) {
            jwplayer("video-container").onAdTime(function (e) {
                ...
                /*if(completeHash.indexOf('-SEPSLIDE-start')<0){
                 var vc = $('#video-container video').get(0);
                 vc.pause();
                 }*/
    ...
    $(document).ready(function () {
       ...
       /* $('#closer').css('display', 'none');
        $('#video-section').removeClass('active').hide();
        $('div:last').removeClass('video-active');
        $('#lightbox').hide();*/
        //openVideo('HERO_30_YAHOO-640.mp4','intro',true,'HERO_30_YAHOO-640.jpg')
        ...
        if (isMobile.any) {
            ...
            if ($('#video-container').length > 0) {
                ...
                $('#arrow-left,#arrow-right,#videoIconRight,#videoIconLeft').click(function () {
                    ...
                    //openVideo('HERO_30_YAHOO-640.mp4','intro',true,'HERO_30_YAHOO-640.jpg');//it takes forth parameter for video poster image as eg. ('myVideo.mp4','intro',true,'myPosterImage.jpg/png/gif')
