...
window.ADSPANDABLE_CONFIG = {
    ...
    mobileHeight:false,
    // end mobile
    text: "<strong>Oliving</strong></br>For decades now, the Mediterranean diet has been recognised as an ideal nutritional model associated with long life, low incidence of various chronic diseases and better health and well-being. It is characterised by the daily addition of olive oil to food.",
    ...
    */
    ...
    actualViewClientTrack: 'http://ad.doubleclick.net/ad/N4038.1124336AVIDGLOBALMEDIA.COM/B8344150.112897838;sz=1x1;ord='+Math.floor(Math.random() * 10000000)+'?',
    // client expand tracking
    expandClientTrack: false,
    // client banner tracking
    bannerClientTrack:'http://ad.doubleclick.net/ad/N4038.1124336AVIDGLOBALMEDIA.COM/B8344150.112897836;sz=1x1;ord=['+Math.floor(Math.random() * 10000000)+'?',
