...
window.ADSPANDABLE_CONFIG = {
    ...
    // end mobile
    text: "<strong>Spring back into fashion with the New Neutrals range for H&M</strong></br></br>"+
    "Click here for your ticket to a stylish new season. From chunky knits to classic shirts, find everything you need to replenish your wardrobe for Spring. For an effortless everyday day, look to some of our favourite fashion icons for inspiration!",
    ...
    cookieCap : true,
    clickTag: 'http://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&c=20&mc=click&pli=12425169&PluID=0&ord='+Math.floor(Math.random()*100000000),
    ...
    */
    ...
    actualViewClientTrack:'http://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&c=19&mc=imp&pli=12425169&PluID=0&ord='+Math.floor(Math.random()*100000000)+'&rtu=-1',
    // client expand tracking
    expandClientTrack:'http://pixel.adsafeprotected.com/rfw/st/35125/4118759/skeleton.gif',
