...
// mobile video controls
    ...
    function hashChangedCallback(newHash, oldHash) {
        ...
        if (newHash.indexOf('-SEPSLIDE-start') > -1) {
            ...
            if ($('#video-section').length > 0) {
                ...
                if(typeof jwplayer() == 'undefined'){
                    openVideo('betty_video-640.m3u8','intro',true,'betty_video-640.jpg');
                }
                else {
    ...
    var videoPlayer = function (video, posterImage, videoPrettyName) {
                ...
                playlist: [{
                    ...
                    sources: [
                        /*{file: "rtmp://flash.adspdbl.com/cfx/st/mp4:" + campaign + '/' + video},
                         ...
                         // this next line is iphone streaming - need to have mp4 on maxcdn for this
                         //{file: "http://flash2.adspdbl.com/play/_definst_/mp4:vod/avidvideo.avidm/"+campaign+"/"+video+"/playlist.m3u8"},*/
                        {file: "http://files.adspdbl.com/betty_crocker_001/assets/" + video.replace('m3u8','mp4')},
                        {file: "http://files.adspdbl.com/betty_crocker_001/assets/" + video.replace('m3u8','webm')}
                    ]
                }],
                width: "100%",
                height: "100%",
        ...
        jwplayer().onTime(function(e){
            ...
            if(!mobAutoInitPause && !contentplay){
        ...
        if (isMobile.any) {
            ...
            if ($('#video-container').length > 0) {
                if ($('#video-section, #video-container').css('marginTop') == 0 + 'px') {
                    $('#video-section, #video-container').css({height: '90%', marginTop: '5.5%'});
                }
                /*
                ...
                $('#arrow-left,#arrow-right,#videoIconRight,#videoIconLeft').click(function () {
                    ...
                    openVideo('betty_video-640.m3u8','intro',true,'betty_video-640.jpg');//it takes forth parameter for video poster image as eg. ('myVideo.mp4','intro',true,'myPosterImage.jpg/png/gif')
