...
window.ADSPANDABLE_CONFIG = {
    ...
    // end mobile
    text: "<strong>Bake Someone Happy…this Easter</strong></br>"+
    "Why not try this fun Chocolate Easter Cake Pops recipe which is great for getting the kids involved at Easter",
    ...
    cookieCap : true,
    clickTag: 'http://www.bettycrocker.co.uk/',
    ...
    */
    ...
    actualViewClientTrack: 'http://ad.doubleclick.net/ddm/trackimpi/N5532.1747852.AVID.COMUK/B8546780.116932985;dc_trk_aid=289850523;dc_trk_cid=62101058;ord='+Math.floor(Math.random()*1000000000),
    // client expand tracking
    expandClientTrack: false,
    // client banner tracking
    bannerClientTrack:false,
    // client teaserinview tracking
    teaserInViewTrack:'http://ad.doubleclick.net/ddm/trackimpi/N5532.1747852.AVID.COMUK/B8546780.116945217;dc_trk_aid=289850359;dc_trk_cid=62101058;ord='+Math.floor(Math.random()*1000000000),
    // paragraph to insert
    paraToInsert: 2,
    // keyword threshold
    keywordThreshold: 1,
