...
window.ADSPANDABLE_CONFIG = {
    ...
    text: "<strong>The Smart way from Birmingham to North America</strong></br></br>"+
    "Fly with Aer Lingus, Ireland's only four star airline, and pre&#45;clear US Immigration in Dublin. That'll let you just grab your bags, skip the queues and head straight downtown when you arrive. For great value fares to top stateside destinations, visit <span style='color:#3469d5'>aerlingus.com</span>",
