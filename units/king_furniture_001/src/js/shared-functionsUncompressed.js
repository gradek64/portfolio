    ...
    function hashChangedCallback(newHash, oldHash) {
        ...
        if (newHash.indexOf('-SEPSLIDE-start') > -1) {
            ...
            if ($('#video-section').length > 0 && !isMobile.any) {
                ...
                if(typeof jwplayer() == 'undefined'){
                    openVideo('KNG0044-R-30-N-640.mp4','intro',true,'KNG0044-R-30-N-640.jpg');
                }
                else {
            ...
            jwplayer('video-container').setup({
                playlist: [{
                    ...
                    sources: [
                        ...
                        {file: "http://files.adspdbl.com/king_furniture_001/assets/" + video.replace('m3u8','mp4')},
                        {file: "http://files.adspdbl.com/king_furniture_001/assets/" + video.replace('m3u8','webm')}
                    ]
                }],
                width: "100%",
                height: "100%",
