...
window.ADSPANDABLE_CONFIG = {
    ...
    // end mobile
    text: "<strong>Transform your infrastructure. Fast.</strong></br></br>EMC VSPEX lets you choose Converged Infrastructure solutions and a Hyper&ndash;Converged appliance that takes your infrastructure to a whole, new level, quickly and easily.</br>TOTALLY SIMPLIFY YOUR IT",
    ...
    cookieCap: true,
    clickTag: 'https://ad.doubleclick.net/ddm/clk/293280899;120435304;h',
    ...
    actualViewClientTrack: 'https://ad.doubleclick.net/ddm/ad/N6543.1312838AVID.COM/B8878367.120435304;sz=1x1;ord='+Math.floor(Math.random()*1000000000)+'?',
    // client expand tracking no Nielsen tag
