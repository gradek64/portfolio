    ...
    function hashChangedCallback(newHash, oldHash) {
        ...
        if (newHash.indexOf('-SEPSLIDE-start') > -1) {
            ...
            if ($('#video-section').length > 0) {
                ...
                if(typeof jwplayer() == 'undefined'){
                    openVideo('MCE-MICR116-060NOSLATE-640.m3u8','intro',true,'MCE-MICR116-060NOSLATE-640.jpg');
                }
                else {
        ...
        if (isMobile.any) {
            ...
            if ($('#video-container').length > 0) {
                ...
                /*
                 ...
                 openVideo('MCE-MICR116-060NOSLATE-640.m3u8','intro',true,'MCE-MICR116-060NOSLATE-640.jpg');//it takes forth parameter for video poster image as eg. ('myVideo.mp4','intro',true,'myPosterImage.jpg/png/gif')
