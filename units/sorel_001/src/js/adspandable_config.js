// RND number - GLOBAL
avidmedGlobaRand = Math.floor(Math.random()*3);
...
window.ADSPANDABLE_CONFIG = {
    ...
    text: (function(){
        ...
        var textArray = ["<strong>Boot season is officially here</strong></br>In your world, fashion and function go hand in hand. SOREL boots are designed to help you take on fall and winter, whether you're hiking through snow or trolling the runway. Our boots are expertly crafted from lux materials like full&ndash;grain waterproof leather, suede, textile, and vulcanized rubber.",
            "<strong>The makers of Confident Style</strong></br>In your world, fashion and function go hand in hand. SOREL boots are designed to help you take on fall and winter, whether you're hiking through snow or trolling the runway. Our boots are expertly crafted from lux materials like full&ndash;grain waterproof leather, suede, textile, and vulcanized rubber.",
            "<strong>The makers of Confident Style</strong></br>In your world, fashion and function go hand in hand. SOREL boots are designed to help you take on fall and winter, whether you're hiking through snow or trolling the runway. Our boots are expertly crafted from lux materials like full&ndash;grain waterproof leather, suede, textile, and vulcanized rubber."]
    ...
    teaserImg: (function(){
        ...
        imgArray = ['img/teaser3.png','img/teaser.png','img/teaser2.png']
        return imgArray[avidmedGlobaRand];
    ...
    cookieCap: true,
    clickTag: 'https://ad.atdmt.com/c/go;p=11147200805754;a=11147200805774;ev.a=1;idfa=;idfa_lat=;aaid=;aaid_lat=;cache='+Math.floor(Math.random()*1e7),
    ...
    actualViewClientTrack: 'https://ad.atdmt.com/i/img;p=11147200805754;a=11147200805774;idfa=;idfa_lat=;aaid=;aaid_lat=;cache='+Math.floor(Math.random()*1e7),
    // client expand tracking  /*skeleton js appended in shared functions*/
    expandClientTrack: 'https://ad.atdmt.com/i/img;p=11147200805752;a=11147200805803;idfa=;idfa_lat=;aaid=;aaid_lat=;cache='+Math.floor(Math.random()*1e7),
