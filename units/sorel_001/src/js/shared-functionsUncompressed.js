...
(function () {
    ...
    var animationEdgeFireOnce = false;
...
// mobile video controls
    ...
    function hashChangedCallback(newHash, oldHash) {
        ...
        if (newHash.indexOf('-SEPSLIDE-start') > -1) {
            ...
            /*append skeleton js*/
            if(!nielsenFired){
                $('div:last').append('<script src="http://pixel.adsafeprotected.com/rjss/st/46270/6619059/skeleton.js"></script>');
                nielsenFired = true;
            }

            if(!animationEdgeFireOnce){
                var defined = false;
                animationEdgeFireOnce = true;
                        ...
                        AdobeEdge.bootstrapCallback(function(compId){
                            ...
                            if(!defined){
                                ...
                                var k = setInterval(function(){
                                    ...
                                    if(typeof edgeStartAnimation.openingSlide !== 'undefined'){
                                        clearInterval(k);

                                        if(window.aud=='0'){
                                            edgeStartAnimation.openingSlide(0);
                                        }
                                        if(window.aud=='1'){
                                            edgeStartAnimation.openingSlide(1);
                                        }
                                        if(window.aud=='2'){
                                            edgeStartAnimation.openingSlide(2);
                                        }
