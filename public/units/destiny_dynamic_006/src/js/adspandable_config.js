...
window.ADSPANDABLE_CONFIG = {
    ...
    // end mobile
    text: "<strong>THE COMPLETE DESTINY EXPERIENCE</strong></br></br>The Taken King &mdash; Legendary Edition gives you the next great adventure in Destiny and is perfect for new and existing Guardians that are ready to jump into the Destiny universe or continue to carve their legend in the stars. Available Sept 15th, 2015 on disc and digital download",
    ...
    cookieCap: true,
    clickTag: 'http://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&c=20&mc=click&pli=14639557&PluID=0&ord='+Math.floor(Math.random()*1000000000),
    ...
    actualViewClientTrack: 'http://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&c=19&mc=imp&pli=14639557&PluID=0&ord='+Math.floor(Math.random()*1000000000)+'&rtu=-1',
