...
window.ADSPANDABLE_CONFIG = {
    ...
    campaign: 'asda_xmas_dec16-part2',
    width: '700px',
    height: '434px',
    // mobile
    mobileVersion: false,
    ...
    text: "<strong>Christmas made better</strong></br></br>"+
    "From the ultimate gingerbread house to a showstopper DIY Christmas wreath, Asda has everything you will need to create your very own winter wonderland. Click here for more ideas.",
    // put percentage random number calculation below

    /* teaser in middle
    text: "<img src='http://files.adspdbl.com/campaign-name/img/teaser.jpg' /><style>#teaser-img-wrap {display: none;} p.tteaserText > img {margin:0 auto !important; max-width: 100%; clear: both; display: block; border:1px solid red;}</style>",
    // put percentage random number calculation below */
    ...
    cookieCap: true,
    clickTag: 'https://ad.doubleclick.net/ddm/trackclk/N401804.1747852AVID.COMUK/B10445722.142085053;dc_trk_aid=313867530;dc_trk_cid=75750241;dc_lat=;dc_rdid=;tag_for_child_directed_treatment='+Math.floor(Math.random()*1e7),
    ...
    actualViewClientTrack: 'https://ad.doubleclick.net/ddm/trackimp/N401804.1747852AVID.COMUK/B10445722.142085053;dc_trk_aid=313867530;dc_trk_cid=75750241;ord='+Math.floor(Math.random()*1e7)+';dc_lat=;dc_rdid=;tag_for_child_directed_treatment=?',
