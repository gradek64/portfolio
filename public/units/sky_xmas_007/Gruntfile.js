...
module.exports = function(grunt) {
      ...
      ffmpegInstall : {
        ...
        mpegConvert : {
            ...
            command : [
                ...
                'for f in src/assets/*.mp4; do ffmpeg -i "$f" -f mpeg1video -vf "crop=iw-mod(iw\\,2):ih-mod(ih\\,2)" -b 250k "$f".mpg -y; done'
            ].join('&&')
        },
  ...
  // Default task.
  grunt.registerTask('default', ['jshint', 'concat', 'uglify','replace:edgeReplace','processhtml', 'shell:homebrewInstall' , 'shell:ffmpegInstall', 'responsive_videos', 'copy', 's3', 'clean', 'taskHelper', 'replace:videoReplace','shell:mpegConvert']);
