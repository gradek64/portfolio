...
window.ADSPANDABLE_CONFIG = {
    ...
    // end mobile
    text: "<strong>Tis the season...</strong></br></br>To spoil yourself and ensure you are the envy of all of your colleagues at the Xmas party. H&M's Christmas collection is now available in store and online, with a range of party dresses and shoes! Your winter wardrobe isn't complete without their \"Elfie Selfie\" sweater for the obligatory Christmas jumper day in the office! Click here to find out more and have a #HappyAndMerry Christmas!",
    ...
    cookieCap: true,
    clickTag: 'http://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&c=20&mc=click&pli=15691226&PluID=0&ord=' + Math.floor(Math.random()*10000000),
    ...
    actualViewClientTrack: 'http://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&c=19&mc=imp&pli=15691226&PluID=0&ord='+Math.floor(Math.random()*1000000)+'&rtu=-1',
