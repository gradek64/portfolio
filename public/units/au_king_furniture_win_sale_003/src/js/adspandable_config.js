...
window.ADSPANDABLE_CONFIG = {
    ...
    campaign: 'au_king_furniture_win_sale_003',
    width: '640px',
    height: '360px',
    // mobile
    mobileVersion: false,
    ...
    // end mobile
    text: "<strong>King Living Winter Sale</strong><br/><br/>"+
    "Style your home this season at the King Living Winter Sale. Save on a range of Sofas, Beds, Dining Tables and more. Visit your nearest Showroom and save up to 50&#37; OFF on selected furniture designs!",
    ...
    cookieCap: true,
    clickTag: 'http://ad.doubleclick.net/ddm/clk/292457905;119677977;g',
    ...
    actualViewClientTrack: 'http://ad.doubleclick.net/ddm/ad/N799.1124336AVIDGLOBALMEDIA.COM/B8836258.119677977;sz=1x1;ord='+Math.floor(Math.random()*10000000000)+'?',
    ...
    iframeTags: false,
    keywords: ["Customer service software","Help desk software","Case management software","Service desk","Case management system","service management software","Call centre software","Customer service system","Ticketing software","Help desk system","Call centre crm","Call centre solution","Call centre crm software","Contact centre technology","call centre system","virtual call centre software","cloud contact centre","call centre system software","cloud contact centre software","call managment software","contact centre solutions","Customer service management software","Customer service management solutions","Computer telephony integration","Computer telephony integration software","CTI telephony","CTI software","CTI Systems","CTI Solutions","average handling time","average handle time","call handling time","deflection rates","first time resolution","first call resolution","first contact resolution"],
    customFilterJs: (function () {
        ...
        // sheknows article to now show the add
        if(dd.indexOf('sheknows.com')>-1 && (lh.indexOf('living/articles/1082562/how-to-plan-a-themed-road-trip-in-australia')>0 || lh.indexOf('living/articles/1082922/road-trip-scavenger-hunt')>0 || lh.indexOf('road-trip-necessities-for-your-next-family-adventure/road-trip-supplies')>0 || lh.indexOf('living/articles/1060615/long-weekend-ideas-plans')>0 || lh.indexOf('pet-friendly-weekend-adventures')>0 )){
            rt = false;
        }
