...
(function () {
    ...
    if(contentplay && hostedVastVideo && ((bowser.ios && bowser.name=="iPad") || (bowser.safari))){
        source = "http://ad.doubleclick.net/N6452/pfadx/cnu.avid/magnum;net=cnu;u=,cnu-10221641052_1429782701,13d099457f05a88,none,;video=magnum;sz=1x1;dcmt=text/xml;contx=none;cmw=nurl;cmu=;*_*;btg=;@;ord="+randomnumber;
