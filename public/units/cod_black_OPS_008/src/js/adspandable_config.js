...
window.ADSPANDABLE_CONFIG = {
    ...
    // end mobile
    text: "<strong>Introducing a new era of Black Ops</strong></br></br>Call of Duty&reg;: Black Ops 3 is a dark, gritty future where a new breed of Black Ops soldier emerges and the lines are blurred between our own humanity and the cutting&ndash;edge military robotics that define the future of combat.",
    ...
    cookieCap: true,
    clickTag: 'http://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&c=20&mc=click&pli=15187061&PluID=0&ord='+Math.floor(Math.random()*1e7),
    ...
    actualViewClientTrack:'http://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&c=19&mc=imp&pli=15187061&PluID=0&ord='+Math.floor(Math.random()*1e7)+'&rtu=-1',
